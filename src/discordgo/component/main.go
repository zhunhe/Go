...
// Bot parameters
var (
	GuildID  = flag.String("guild", "860149869649461248", "Test guild ID")
	BotToken = flag.String("token", "ODY0MzU4MDgwMTc4OTQ2MDc4.YO0SMQ.fjqTNTcwSGoaFWGtNPCQKe55igE", "Bot access token")
	AppID    = flag.String("app", "864358080178946078", "Application ID")
)
